...
MAX_REQUEST_BYTES = 100 * 1024 * 1024  # 100 MB — raised from 10 MB so remote OpenAI-compatible clients (Open WebUI etc.) can upload large attachments via base64 in chat bodies
